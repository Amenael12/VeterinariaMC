...
<body>
    ...
    <form action="ActualizarServicio.php" method="POST">
        <div class="container">
            ...
            $result = mysqli_query($mysqli,"SELECT * FROM tb_servicios WHERE id_servicio =$id");
            while($row = mysqli_fetch_array($result)){
                echo"<input type='hidden' name='id' value='{$row['id_servicio']}' required>";
                ...
                echo"<input type='number' placeholder='1.0' step='0.01' min='0' name='costo' value='{$row['costo']}' required>";
