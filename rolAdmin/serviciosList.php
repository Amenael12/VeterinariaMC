 ...
 <?php
       ...
       <tr>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td><a href='editarServicio.php?id=" . $row['id_servicio'] . "'><img src='../images/icons8-Edit-32.png' alt='Edit'></a></td>";
            echo "<td><a href='EliminarServicio.php?id=" . $row['id_servicio'] . "'><img src='../images/icons8-Trash-32.png' alt='Delete'></a></td>";
            echo "</tr>";
        }
        echo "</table>";
        //Fin de la tabla
