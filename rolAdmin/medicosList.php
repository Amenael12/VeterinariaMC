...
$query = "SELECT * FROM tb_medicos WHERE estado = 1";
 ...
 <?php
       ...
       <tr>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td><a href='editarMedico.php?id=" . $row['id_medico'] . "'><img src='../images/icons8-Edit-32.png' alt='Edit'></a></td>";
            echo "<td><a href='EliminarMedico.php?id=" . $row['id_medico'] . "'><img src='../images/icons8-Trash-32.png' alt='Delete'></a></td>";
            echo "</tr>";
        }
        echo "</table>";
        //Fin de la tabla
